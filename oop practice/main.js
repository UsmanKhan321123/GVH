...
//                  access modifiers
class Access {
    name; // private ko hum sirf is hi class main acces kr sakty hain.....baqi neechay ek masla lkh raha hun iska
    uni;
    semester;
    #secret = "good boy"; // ab yeh pakka private hogaya hai "#" sy. ab is ko kisi bhi tarha access nahi kr sakty humm
}
...
let objofChildAccess = new ChildAccess();
